...
#ifndef __GEODA_CENTER_AGGREGATION_DLG_H__
#define __GEODA_CENTER_AGGREGATION_DLG_H__
...
class AggregationDlg: public wxDialog, public FramesManagerObserver
{    
public:
    AggregationDlg(wxWindow* parent,
                  Project* project_p,
                  const wxPoint& pos = wxDefaultPosition);
	virtual ~AggregationDlg();
