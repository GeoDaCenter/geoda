...
#ifndef __GEODA_CENTER_FIELD_NEW_CALC_DT_DLG_H__
#define __GEODA_CENTER_FIELD_NEW_CALC_DT_DLG_H__
...
class FieldNewCalcDateTimeDlg: public wxPanel
{    
    DECLARE_EVENT_TABLE()
...
public:
    FieldNewCalcDateTimeDlg(Project* project,
					   ...
					   const wxString& caption = "Data/Time",
