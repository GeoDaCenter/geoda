...
void KMeansDlg::CreateControls()
{
    ...
    wxComboBox* box1 = new wxComboBox(panel, wxID_ANY, _(""), wxDefaultPosition,
                                      wxSize(160,-1), 9, choices, wxCB_READONLY);
    ...
    wxStaticText* st11 = new wxStaticText(panel, wxID_ANY, _("# of Iterations (EM):"),
                                         wxDefaultPosition, wxSize(122,-1));
    wxTextCtrl  *box11 = new wxTextCtrl(panel, wxID_ANY, wxT("5"), wxDefaultPosition, wxSize(158,-1));
    ...
    wxComboBox* box12 = new wxComboBox(panel, wxID_ANY, _(""), wxDefaultPosition,
                                       wxSize(160,-1), 2, choices12, wxCB_READONLY);
    gbox->Add(st12, 0, wxALIGN_CENTER_VERTICAL | wxRIGHT | wxLEFT, 10);
    gbox->Add(box12, 1, wxEXPAND);
    
    wxStaticText* st13 = new wxStaticText(panel, wxID_ANY, _("Distance Function:"),
                                          wxDefaultPosition, wxSize(122,-1));
    wxString choices13[] = {"Euclidean distance", "Pearson correlation coefficient","Absolute value of the Pearson correlation coefficient","Uncentered Pearson correlation","Absolute uncentered Pearson correlation","Spearman’s rank correlation","Kendall's Tao","City-block distance"};
    wxComboBox* box13 = new wxComboBox(panel, wxID_ANY, _(""), wxDefaultPosition,
                                      wxSize(160,-1), 8, choices13, wxCB_READONLY);
    ...
    */
    ...
    closeButton->Bind(wxEVT_BUTTON, &KMeansDlg::OnClose, this);
}
...
void KMeansDlg::OnClose(wxCommandEvent& event )
{
...
void KMeansDlg::OnOK(wxCommandEvent& event )
{
    ...
    for (int i=0; i<rows; i++) {
        delete[] input_data[i];
        delete[] mask[i];
        clusters.push_back(clusterid[i]);
