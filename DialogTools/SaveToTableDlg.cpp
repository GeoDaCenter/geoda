...
const int ID_ADD_BUTTON = XRCID("SAVETOTABLEDLG_ADD_BUTTON");
const int ID_FIELD_CHOICE = XRCID("SAVETOTABLEDLG_FIELD_CHOICE");
const int ID_TIME_CHOICE = XRCID("SAVETOTABLEDLG_TIME_CHOICE");
const int ID_CHECK = XRCID("SAVETOTABLEDLG_CHECK");
const int ID_FIELD_TEXT = XRCID("SAVETOTABLEDLG_FIELD_TEXT");
