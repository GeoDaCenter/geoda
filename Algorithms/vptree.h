...
static inline double euclidean_distance_squared(const DataPoint &t1, const DataPoint &t2) {
    double dd = .0;
...
private:
    ...
    void search(Node* node, const DataPoint& target, unsigned int k, std::priority_queue<HeapItem>& heap, double& tau)
    {
