...
long int	*d, *n, *parameter, *a, *degree, *nonparametric, *drop_square,
	*sum_drop_sqr, *setLf;
char	**surf_stat;
{
...
long int	*degree, *nonparametric, *drop_square, *sum_drop_sqr, *d, *n, *m;
{
...
long int	*family, *degree, *nonparametric, *drop_square, *sum_drop_sqr,
	*d, *n, *m; 
{
	long int	zero = 0, one = 1, two = 2;
        double fzero = 0.0;
...
loess_workspace(d, n, span, degree, nonparametric, drop_square, 
	sum_drop_sqr, setLf)
long int	*d, *n, *degree, *nonparametric, *drop_square, *sum_drop_sqr,
	*setLf;
double	*span;
{
	...
	liv = 50 + ((long int)pow((double)2, (double)D) + 4) * nvmax + 2 * N;
	if(*setLf) {
		lv = lv + (D + 1) * nf * nvmax;
		liv = liv + nf * nvmax;	
	}
...
loess_prune(parameter, a, xi, vert, vval)
double	*xi, *vert, *vval;
long int	*parameter, *a;
{
	long int	d, vc, a1, v1, xi1, vv1, nc, nv, nvmax, i, j, k;
...
long int	*parameter, *a;
{
	long int	d, vc, nc, nv, a1, v1, xi1, vv1, i, j, k;
