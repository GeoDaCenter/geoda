...
"\n高德.卫星,http://webst01.is.autonavi.com/appmaptile?style=6&x={x}&y={y}&z={z}"
"\n高德.卫星.有标签,http://webst01.is.autonavi.com/appmaptile?style=8&x={x}&y={y}&z={z}"
"\n天地图,http://t0.tianditu.cn/DataServer?T=vec_w&X={x}&Y={y}&L={z}"
"\n天地图.卫星,http://t0.tianditu.cn/DataServer?T=cia_w&X={x}&Y={y}&L={z}"
"\n天地图.地形,http://t0.tianditu.cn/DataServer?T=cta_w&X={x}&Y={y}&L={z}"
;
