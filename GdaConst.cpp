...
const char* GdaConst::sample_names[] = {
    ...
    "Nepal Aid: Health, poverty and education indicators",
    "NYC Subborough Data",
    "Malaria Colombia Cities",
    "Phoenix ACS: Phoenix American Community Survey Data 2010",
    "San Francisco Crime: July-Dec 2012 crime incidents",
...
const char* GdaConst::sample_datasources[] = {
    ...
    "http://geodacenter.github.io/sample_data/buenosaires.geojson",
    "http://geodacenter.github.io/sample_data/wi_final_census2_random4.geojson",
    "http://geodacenter.github.io/sample_data/coldept.geojson",
    "http://geodacenter.github.io/sample_data/stl_hom.geojson",
