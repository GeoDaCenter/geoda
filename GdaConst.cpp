...
const wxString GdaConst::gda_lbl_1p = _("< 1%");
const wxString GdaConst::gda_lbl_1p_10p = _("1% - 10%");
const wxString GdaConst::gda_lbl_10p_50p = _("10% - 50%");
const wxString GdaConst::gda_lbl_50p_90p = _("50% - 90%");
const wxString GdaConst::gda_lbl_90p_99p = _("90% - 99%");
const wxString GdaConst::gda_lbl_99p = _("> 99%");
const wxString GdaConst::gda_lbl_loweroutlier = _("Lower outlier");
const wxString GdaConst::gda_lbl_25p = _("< 25%");
const wxString GdaConst::gda_lbl_25p_50p = _("25% - 50%");
const wxString GdaConst::gda_lbl_50p_75p = _("50% - 75%");
const wxString GdaConst::gda_lbl_75p = _("> 75%");
const wxString GdaConst::gda_lbl_upperoutlier = _("Upper outlier");
const wxString GdaConst::gda_lbl_n2sigma = _("< -2Std");
const wxString GdaConst::gda_lbl_n2sigma_n1sigma = _("[-2Std, -1Std)");
const wxString GdaConst::gda_lbl_n1sigma = _("[-1Std, Mean)");
const wxString GdaConst::gda_lbl_1sigma = _("(Mean, 1Std]");
const wxString GdaConst::gda_lbl_1sigma_2sigma = _("(1Std, 2Std]");
const wxString GdaConst::gda_lbl_2sigma = _("> 2Std");
...
const wxColour GdaConst::conn_neighbor_outline_colour(55,55,55);
const wxColour GdaConst::conn_neighbor_fill_colour(255,255,255);
